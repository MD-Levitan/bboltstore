...
// 	db, err := bbolt.Open(benchmarkDB, 0666, nil)
// 	if err != nil {
// 		panic(err)
// 	}
// 	defer db.Close()
...
// 		panic(err)
// 	}
// 	data, err := json.Marshal(NewSession([]byte{}, DefaultMaxAge))
// 	if err != nil {
// 		panic(err)
// 	}
...
func TestSession_delete_new(t *testing.T) {
	db, err := bbolt.Open("./sessions.db", 0666, nil)
	if err != nil {
		t.Error(err)
	}
...
// 	// db(*bbolt.DB) should be opened beforehand and passed by the other function.
// 	var db *bbolt.DB
